  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <h2 className="text-[#171717] text-3xl md:text-5xl text-center mb-12" style={{ fontFamily: 'var(--font-the-seasons), serif' }}>
          {title}
        </h2>
            ...
            <div className={`flex justify-center gap-16 mb-16 flex-wrap ${isEven ? 'max-w-5xl mx-auto' : ''}`}>
              {firstRow.map((member, index) => (
                <div key={index} className="flex flex-col items-center">
                  ...
                  <p className="text-[#171717] text-xl" style={{ fontFamily: 'var(--font-the-seasons), serif' }}>{member.name}</p>
                </div>
              ))}
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* SVG Chevron */}
                      <div aria-hidden="true" className={`transform transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
