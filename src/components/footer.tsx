    ...
    <footer>
      <div className="relative h-64 md:h-80 flex flex-col items-center justify-center text-white px-6">
        ...
        <div className="relative z-10 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 px-5 py-2 rounded bg-[#F7B923] text-black">
      ...
      <div className="bg-[#DFB97B] md:px-12 md:py-8 flex flex-row items-center justify-between">
        <Image src="/logoblack.png" alt="Copper to Gold logo" width={192} height={48} className="md:w-48 mx-[4vw]" />
        
        <div className="text-left md:text-l text-m pr-4 md:pr-8 mx-[8vw]">
